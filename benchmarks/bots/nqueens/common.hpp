...
inline auto ok(unsigned int n, std::span<const unsigned char> solution) -> bool
{
...
inline auto nqueens_serial(unsigned int j, std::span<unsigned char> scratchpad)
    -> unsigned int
{
...
inline auto nqueens_prefixes(unsigned int start,
                             unsigned int end,
                             unsigned int j,
                             unsigned int n,
...
inline auto pow(unsigned int base, unsigned int exp)
{
  unsigned int res = 1;
...
inline auto parse_args(argparse::ArgumentParser& program,
                       int argc,
                       char* argv[]) -> common_args
{
